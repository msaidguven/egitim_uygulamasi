...
class SmartQuestionAdditionPage extends StatefulWidget {
  const SmartQuestionAdditionPage({super.key});

  @override
  State<SmartQuestionAdditionPage> createState() => _SmartQuestionAdditionPageState();
}
...
class _SmartQuestionAdditionPageState extends State<SmartQuestionAdditionPage> {
  ...
  Future<void> _loadUnits(int gradeId, int lessonId) async {
    setState(() => _isLoading = true);
    try {
      final units = await _unitService.getUnitsForGradeAndLesson(gradeId, lessonId);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Akıllı Soru Ekleme'),
      ),
