...
class HomeV3Screen extends ConsumerStatefulWidget {
  final Profile? profile;

  const HomeV3Screen({super.key, this.profile});

  @override
  ConsumerState<HomeV3Screen> createState() => _HomeV3ScreenState();
}

class _HomeV3ScreenState extends ConsumerState<HomeV3Screen> {
  ...
  Future<void> _fetchDashboardData() async {
    ...
    try {
      ...
      debugPrint('HomeV3 dashboard verisi çekilirken hata: $e');
      if (!mounted) return;
      setState(() {
        _isLoading = false;
      });
