-- Resolve weekly contents primarily by topic_content_outcomes + outcome_weeks,
-- with fallback to topic_content_weeks for backward compatibility.
    ...
    SELECT
      ...
      (
        ...
        WHERE tc.topic_id = t.id
          ...
          AND (tco.outcome_id IS NOT NULL OR tcw.topic_content_id IS NOT NULL)
      ) AS contents,
      (
