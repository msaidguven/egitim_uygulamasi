...
CONSTRAINT user_answers_user_fkey FOREIGN KEY (user_id) REFERENCES public.profiles(id),
CONSTRAINT user_answers_question_fkey FOREIGN KEY (question_id) REFERENCES public.questions(id)
);
